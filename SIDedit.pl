...
sub About {
    ...
    $text  = "\nInstruction definitions for disassembler\nlifted from Michael Schwendt's sid_dis source.\n";
    $text .= "\nSID name to long filename conversion\nlifted from The Shark's SID2LFN.\n";

    $using  = "\nUses Audio::SID v" . Audio::SID->VERSION . ", ";
    $using .= "(C) 1999, 2004 LaLa <LaLa\@C64.org>\n";
    $using .= "and the latest version of Perl/Tk.\n";
    $using .= "\nWindows version converted to executable with\n";
    $using .= "Perl2EXE v8.00 beta, ";
    $using .= "(c) 1997-2003 IndigoSTAR Software\n";
    ...
    $dialog->add("Label", -text => "Visit http://lala.c64.org for the latest update.", -font => [@boldFont])
        ->grid(-column => 1, -row => ++$row, -columnspan => 2, -sticky => 'ew');
